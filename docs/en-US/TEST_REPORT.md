...
| `resolver-advanced.test.ts`         | 19         | ✅ All passed | Resolver plugin advanced tests (incl. CSS import resolution, view/TSX/JSX compile); output under tests/data/resolver-advanced, auto-cleanup after run |
...
- **571** tests (Deno `deno test -A`, all passed, ~28s)
...
- ✅ Resolver plugin tests (Deno and Bun; CSS import resolution, view main-entry
