...
| `resolver-advanced.test.ts`         | 19     | ✅ 全部通过 | 解析器插件高级测试（含 CSS 导入解析、view/TSX/JSX 编译；生成文件位于 tests/data/resolver-advanced，测试结束自动清理） |
...
- **解析器**：Deno/Bun 解析器、JSR/npm 子路径、路径别名、相对路径、CSS
  导入解析、view 主入口相对路径与 .tsx loader
  编译；解析器高级测试生成文件统一放在
